...
local Survival = {
	...
	{'#Ancient Healing Potion', 'player.health<=40'},
	{'#Healthstone', 'player.health<=35'},
	{'Aspect of the Turtle', 'player.health<=25'},
	{'Feign Death', 'player.health<=20&equipped(137064)'},
}
...
local Patient_Sniper = {
	...
	{'Windburst', '!moving&!talent(7,1)&player.focus>80{!target.debuff(Hunter\'s Mark)||{target.debuff(Hunter\'s Mark).remains>action(Windburst).execute_time&focus+{focus.regen*target.debuff(Hunter\'s Mark).remains}>=50}}'},
