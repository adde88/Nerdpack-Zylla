...
local exeOnLoad = function()
	...
	NeP.Interface:AddToggle({
		key = 'xVolley',
		name = 'Volley',
		text = 'ON/OFF to auto-use volley.',
	...
	NeP.Interface:AddToggle({
		key = 'xPet',
		name = 'Pet',
		text = 'ON/OFF to auto-use summon Pet.',
...
local PreCombat = {
	{'/cast Call Pet 1', '!pet.exists&!pet.dead&toggle(xPet)'},
	{'Revive Pet', 'pet.dead&toggle(xPet)'},
	{'Volley', 'talent(6,3)&!player.buff(Volley)&toggle(xVolley)'},
}
