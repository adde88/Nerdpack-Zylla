	...
	local Cooldowns = {
		...
		{'Feral Spirit', 'player.buff(Ascendance)||player.hashero'},
		...
		{'Doom Winds', '{player.spell(Flametongue).cooldown<gcd}||{talent(4,3)&player.spell(Frostbrand).cooldown<gcd}'},
		{'Ascendance', '!player.spell(Feral Spirit).cooldown'}
	}
