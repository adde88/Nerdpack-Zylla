...
local PreCombat = {
	...
	{'Cat Form', 'toggle(xFORM)&player.movingfor>0.75&indoors&!player.buff(Cat Form)&!player.buff(Travel Form)&!player.buff(Prowl)', 'player'},
	{'Prowl', 'toggle(xFORM)&!buff&area(40).enemies>=1', 'player'},
...
local Interrupts_Random = {
	...
	{'!Mighty Bash', 'interruptAt(70)&toggle(xIntRandom)&toggle(Interrupts)&range<=5&inFront&player.spell(Skull Bash).cooldown>gcd', 'enemies'}
}
